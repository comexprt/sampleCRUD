...
<head>
  ...
  <title>John Noah - Sample CRUD</title>
...
<div class="container">
    <h2 style="margin-top: 12px;" class="">Simple CRUD APP</h2><br>
    <div class="row">
        <div class="col-12">
          <a href="javascript:void(0)" class="btn btn-danger" style="float: right;" id="create-new-post"><i class="fa fa-plus"></i> New</a> 

          
          <table class="table table-bordered" id="laravel_crud" style="margin-top: 5%;">
           <thead>
              <tr>
                 <th>Date</th>
                 <th>Title</th>
...
<script>
  $(document).ready(function () {
    ...
    $('#create-new-post').click(function () {
        ...
        $('#postCrudModal').html("Add New Note");
 ...
 if ($("#postForm").length > 0) {
     ...
     submitHandler: function(form) {
      ...
      $.ajax({
          ...
          dataType: 'json',
          success: function (data) {
              var post = '<tr id="post_id_' + data.id + '"><td>' + data.created_at + '</td><td>' + data.title + '</td><td>' + data.body + '</td>';
